...
export interface Storage {
  ...
  saveTasks(userType: UserType, sessionId: string | undefined, boardId: string | undefined, tasks: TasksFile): Promise<void>
  getStats(userType: UserType, sessionId?: string, boardId?: string): Promise<StatsFile>
  saveStats(userType: UserType, sessionId: string | undefined, boardId: string | undefined, stats: StatsFile): Promise<void>
