...
Status: **Ratified 2026-07-21.** T0–T5 shipped & prod-verified (2026-07-24); T6–T8 remain.
T5's human-facing UI (My/Shared picker grouping, hidden readonly affordances, shared-board
pinning) is the only deferred piece — TenHands drives shared boards over MCP and is unblocked.
Date: 2026-07-21
