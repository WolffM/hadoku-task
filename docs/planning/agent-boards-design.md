...
Status: **Ratified 2026-07-21.** T0–T6 backend shipped (T0–T5 prod-verified 2026-07-24;
T6 verified in-harness, deploy pending); T7–T8 remain. Deferred UI (not blocking TenHands):
T5's My/Shared picker grouping + shared-board pinning, and T6's two-track render + Edit-Boards
activation affordance — TenHands drives shared + automation boards over MCP/HTTP and is unblocked.
Date: 2026-07-21
